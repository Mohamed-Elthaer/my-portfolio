  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      ...
      >
        ...
        >
          <span
            className="text-secoundary-foreground 
          ...
          animate-delay-100 text-secoundary-foreground"
          >
            Kind words from{" "}
            <span
          ...
          <div className="relative">
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animate-delay-200">
              <div className="absolute -top-4 left-8 w-12 h-12 rounded-full bg-primary flex items-center justify-center">
                <BsQuote className="w-6 h-6 text-primary-foreground" />
              </div>
                ...
                {testimonials.map((_, idx) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${
                      idx === activeIdx
                        ? "w-8 bg-primary"
                        : "bg-muted-forgeground/30 hover:bg-muted-forgeground/50"
                    }`}
                  />
                ))}
              </div>
